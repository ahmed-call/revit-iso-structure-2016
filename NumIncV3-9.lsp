...
;;-----------------------------------------------------------------------------------------------;;
;;                                                                                               ;;
;;  Author: Munir Hussain, Copyright © 2018                                          ;;
;;                                                                                               ;;
;;-----------------------------------------------------------------------------------------------;;
;;                                                                                               ;;
...
;;  an individual or a single entity) and Munir Hussain (the "Author"), for this software product      ;;
;;  (the "Software").                                                                            ;;
;;                                                                                               ;;
        ...
        (   (setq file (open dcl "w"))
            (foreach line
               '(
                    ...
                    "            : text"
                    "            {"
                    "                label = \"Copyright (c) Munir Hussain 2018\";"
                    "                key = \"aut\";"
                    "                alignment = right;"
                    "            }"
                    "        }"
                    ...
                    "    : ctxt { value = \"Designed and Created by Munir Hussain 2018\"; }"
                    "    : button"
                    "    {"
                    "        key = \"weblink\";"
